...
urlpatterns = [
    ...
    path("page/public-self-disclosure/", views.public_self_disclosure,
         name="public_self_disclosure"),
    path("page/vivek-jyoti-samman/", views.vivek_jyoti_samman,
         name="vivek_jyoti_samman"),
    path("page/university-press/", views.university_press, name="university_press"),
    path("page/research-publication-cell/", views.research_publication_cell,
         name="research_publication_cell"),
    path("page/research-funding/", views.research_funding, name="research_funding"),
    path("page/social-outreach-activities/", views.social_outreach,
